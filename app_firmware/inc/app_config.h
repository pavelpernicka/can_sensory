...
typedef enum {
    ...
    APP_CMD_WS_SET_ANIM = 0x55,
    APP_CMD_WS_GET_ANIM = 0x56,
    APP_CMD_WS_SET_GRADIENT = 0x57,
    APP_CMD_WS_GET_GRADIENT = 0x58,
    APP_CMD_WS_SET_SECTOR_COLOR = 0x59,
    APP_CMD_WS_GET_SECTOR_COLOR = 0x5A,
    APP_CMD_WS_SET_SECTOR_MODE = 0x5B,
    APP_CMD_WS_GET_SECTOR_MODE = 0x5C,
    APP_CMD_WS_SET_SECTOR_ZONE = 0x5D,
    APP_CMD_WS_GET_SECTOR_ZONE = 0x5E,
    APP_CMD_WS_SET_LENGTH = 0x5F,
    APP_CMD_WS_GET_LENGTH = 0x60,
    APP_CMD_WS_SET_ACTIVE_SECTOR = 0x61,
...
typedef enum {
    ...
    APP_FRAME_WS_ANIM = 0x48,
    APP_FRAME_WS_GRADIENT = 0x49,
    APP_FRAME_WS_SECTOR_COLOR = 0x4A,
    APP_FRAME_WS_SECTOR_MODE = 0x4B,
    APP_FRAME_WS_SECTOR_ZONE = 0x4C,
    APP_FRAME_WS_LENGTH = 0x4D
} app_frame_t;
